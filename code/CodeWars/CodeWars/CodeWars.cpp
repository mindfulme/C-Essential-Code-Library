...
/* TASK :    A child plays with a ball on the nth floor of a big building. The height of this floor is known: 
...
int main() {
	...
	cout<< "Give me numbers! 1:height of windows 2: mother`s window 3:bounce koeficient" << endl;
	float h, window, bounce;
	cin >> h >> window >> bounce;
